...
class HashTable:
    ...
    def put(self, key, value):
        ...
        if current is not None:
            ...
            new_current = HashTableEntry(key, value)
            new_current.next = self.storage[index]
            self.storage[index] = new_current
